...
const eventOne = (event, element, callback, getThis = false) => {
    if (getThis) {
...
const event = (event, elements, callback, getThis = false) => {
...
//.test .me
const eventAll = (event, parentElement, element, callback) => {
